...
class ModeratorOTPAuth extends StatefulWidget {
  final String phoneNo;
  final String countryCode;
  final String uniqueID;

  const ModeratorOTPAuth({
    super.key,
  ...
  @override
  State<ModeratorOTPAuth> createState() => _ModeratorOTPAuthState();
}

class _ModeratorOTPAuthState extends State<ModeratorOTPAuth> {
  ...
  void verifyOTPViaFirebase() async {
    ...
    try {
      ...
      await setPreference(widget.uniqueID, 'moderator');
