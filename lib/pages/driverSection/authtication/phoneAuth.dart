...
import 'package:swift/pages/driverSection/authtication/OTPauth.dart';
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: UnderlineInputBorder(
                            borderSide:
                                BorderSide(color: Colors.black38, width: 1.2.w),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border.all(
                            ...
                            width: 1.2.w),
                        color: isTen ? Colors.black : const Color(0xFFF4F8FB),
                        borderRadius: BorderRadius.circular(16.r)),
                    child: Center(
                        child: Text(
                      "Continue",
                      style: TextStyle(
                          color: isTen ? Colors.white : const Color(0xFF899CB4),
                          fontFamily: "Montserrat-Bold",
                          fontSize: 17.sp),
                    )),
                  ),
